...
namespace QuanLyCuaHangBanDienThoai
{
    public partial class QuanLy : Form
    {
           ...
           string ns =txtNgaySinh.Text;
            if (btnTimKiemKH.Visible == true)
            {
                if (name == "" && phone == ""&& ns=="")
                    ...
                    loadDataToDataGridView(dtgvKH, customerDao.searchBirthday(ns));
            }
            else
            {
                if (name == "" || phone == "")
                ...
                else
                {
                    if (btnThemKH.Visible == true)
                    {
                        ...
                        {
                            if (customerDao.insert(name, phone,ns))
                            {
                    ...
                    {
                        if (customerDao.update(idCustomer, name, phone,ns))
                        {
        ...
        private void dtgvKH_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtNgaySinh.Text = dtgvKH.CurrentRow.Cells[3].Value.ToString();
