                ...
                if (cbThang.Text != "")//năm+tháng
                {
                    ...
                    else//nếu có sl và doanh thu
                    {
                        ...
                        if (cbLoaiSX.Text == "Số lượng")
                        {
                            ...
                            {
                                if (!rbNV.Checked && !rbKH.Checked && !rbĐT.Checked)
                                    //hiện doanh thu tổng theo số lượng
                                    SXDT("desc", "SLĐT bán");
                                //hiện tổng số lg nhân viên bán theo đk 
                                else if (rbNV.Checked)
                                    SXNV("desc", "SLĐT bán");
                                else if (rbKH.Checked)
                                    SXKH("desc", "SLĐT mua");
